...
class CourseSerializer(serializers.ModelSerializer):
    class Meta:
        model = Course
        fields = ['department', 'course_name','teacher_id','course_code','course_type','year','semester','exam_year','credit']
...
class AssignTeacherToCourseSerializer(serializers.ModelSerializer):
    class Meta:
        model = Course
