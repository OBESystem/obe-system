...
from .serializers import CourseSerializer, AssignmentSerializer, UpdateAssignmentSerializer, UpdateAssignmentPDFSerializer, Class_testSerializer, UpdateClass_testSerializer, UpdateFinal_examSerializer, Final_examSerializer, CourseFileSerializer
