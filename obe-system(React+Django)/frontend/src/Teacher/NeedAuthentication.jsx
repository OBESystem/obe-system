        ...
        <div className="naBdy text-center ">
            <div className="container-flex">
                ...
                <div className="row text-center na">
                    ...
                    <div className="col-1"><button type="button" class="btn btn-primary" onClick={() => navigate("/")}>Go to home</button></div>
                    <div className="col-1"><button type="button" class="btn btn-primary" onClick={() => navigate("/Login")}>Log in</button></div>
                    <div className="col-5"></div>
                </div>
            </div>
        </div>
