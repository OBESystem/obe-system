                ...
                <div className="px-3">
                  ...
                  <div className="container-fluid">
                    ...
                    <label for="department"><strong>Select Department:</strong> </label>
                      <select class="form-select small-dropdown" aria-label="Default select example" name="department" onChange={handleInput}>
                      ...
                      <select class="form-select small-dropdown" aria-label="Default select example" name="year" onChange={handleInput}>
                            <option selected>None</option>
                      ...
                      <div class="dropdown-container">
                      <label for="examYear"><strong>Select Exam Year and Exam Semester: </strong></label>
                      <select class="form-select small-dropdown1" aria-label="Default select example" id="examYear" name="examYear" onChange={handleInput}>
                            <option selected>None</option>
                      ...
                      <select class="form-select small-dropdown1" aria-label="Default select example" name="examSemester" onChange={handleInput}>
                            <option selected>None</option>
