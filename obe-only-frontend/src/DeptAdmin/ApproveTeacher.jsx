                      ...
                      <div className="col-md-12 p-1">
                        <div className="row p-3 bg-white shadow-sm d-flex justify-content-around rounded">
                          <div className="col-md-12 courseInfo">
                            ...
                            <p className="fs-3"><strong>Approve Pending Teacher Account</strong></p>
                        ...
                        <div className="row p-3 bg-white shadow-sm d-flex justify-content-around part rounded" id="assignment">
                          <p>
                            ...
                            onClick={() => {
                              ...
                              // GetInfo();
                            }}>Show Pending Teacher Accounts</button>
                          </p>
                          <div>
                            <table className='table table-striped table-hover teacherTable'>
                              <thead>
                                <th>User ID</th>
                                <th>Name</th>
                                <th>Designation</th>
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td>
                                  <td>Rubayed All Islam</td>
                                  <td>Professor</td>
                                  <td>Computer Science and Engineering</td>
                                  <td>rubayed@gmail.com</td>
                                  <td>+8801864852588</td>
