...
function Sidebar(props) {
    ...
    const goToAcademicCalendar = () => {
        window.open('/UploadAcademicCalendar', '_blank');
        //window.open('/AcademicCalendar', '_self');
    };
    const goToApproveTeacher = () => {
        window.open('/ApproveTeacher', '_blank');
        //window.open('/AcademicCalendar', '_self');
    };

    const goToAssignCourse = () => {
        window.open('/AssignCourse', '_blank');
        //window.open('/AcademicCalendar', '_self');
    };

    const goToCreateExam = () => {
        window.open('/CreateExam', '_blank');
        //window.open('/AcademicCalendar', '_self');
    };
        ...
        <div className="sidebar p-2">
            <div className="m-2">
                ...
                <div className="row">
                    ...
                    <span className="brand-name fs-5">Professor</span>
            ...
            <div className="list-group list-group-flush">
                ...
                <a className="list-group-item py-2" onClick={goToAcademicCalendar}>
                        ...
                        <span className="fs-5">Upload Academic calender</span>
                </a>
                <a className="list-group-item py-2" onClick={goToApproveTeacher}>
                        <i className="bi bi-calendar fs-5 me-3"></i>
                        <span className="fs-5">Approve Teacher Account</span>
                </a>

                <a className="list-group-item py-2" onClick={goToAssignCourse}>
                        <i className="bi bi-calendar fs-5 me-3"></i>
                        <span className="fs-5">Assign Course</span>
                </a>
                <a className="list-group-item py-2" onClick={goToCreateExam}>
                        <i className="bi bi-calendar fs-5 me-3"></i>
                        <span className="fs-5">Create Exam</span>
                </a>
