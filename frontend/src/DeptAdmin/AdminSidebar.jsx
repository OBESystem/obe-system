        ...
        <div className="sidebar p-2">
            <div className="m-2">
                ...
                <div className="row">
                    ...
                    <span className="brand-name fs-5">Department Admin</span>
            ...
            <div className="list-group list-group-flush">
                <a className="list-group-item py-2 listLinkDAdmin" onClick={goToDashboard} >
                ...
                <a className="list-group-item py-2 text-danger listLinkDAdmin" onClick={handleLogout}>
