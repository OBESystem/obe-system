      ...
      if(errors.email === "" && errors.password === "")
      {
        ...
        .then(res => {
          ...
          else
          {
            ...
            {
              alert("Successfully logged in as Department Admin..");
              navigate('/Department-Admin-Dashboard', { state: { email: values.email } });
            }
            else if(type === '3')
            {
              alert("Successfully logged in as Exam Control Office Member....");
              navigate('/Exam-Control-Office-Dashboard', { state: { email: values.email } });
            }
            else
            {
              navigate('/Welcome');
